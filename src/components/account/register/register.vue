        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form id="register-form" name="registerForm" role="form" v-on:submit.prevent="register()" v-if="!success" no-validate>
                    ...
                    <button type="submit" :disabled="$v.registerAccount.$invalid || $v.confirmPassword.$invalid" class="btn btn-primary">Register</button>
                </form>
                <p></p>
            ...
            <div><b-button @click = "back()">BACK</b-button></div>
        </div>
    </div>
</template>
