...
export default class JhiMetrics extends Vue {
      ...
      .then(resultsMetrics => {
        ...
        this.metricsService()
          ...
          .then(res => {
            ...
            this.threadData.forEach((value: any) => {
  ...
  convertMillisecondsToDuration(ms: any) {
    // var times = {
    //   year: 31557600000,
    //   month: 2629746000,
    //   day: 86400000,
    ...
    //   second: 1000
    // };
    const times = [31557600000, 2629746000, 86400000, 3600000, 60000, 1000];
    const measure = ["year", "month", "day", "hour", "minute", "second"];
    let time_string = '';
    let plural = '';
